...
if page == "Intro page":
    ...
    myImage = Image.open("bike-sharing.jpg.jpg") #source: https://ride.divvybikes.com/blog/new-divvy-ebike
    st.image(myImage)
...
### Most popular stations page
    ...
    st.markdown("Streeter Drive/Grand Avenue, Canal Street/Adams Street as well as Clinton Street/Madison Street. While having the aggregated bike trips filter enabled, we can see that even though Clinton Street/Madison Street is a popular station, it doesn't account for the most commonly taken trips.")
    st.markdown("The most common routes (>2,000) are between Theater on the Lake, Streeter Drive/Grand Avenue, Millenium Park, Columbus Dr/Randolph Street, Shedd Aquarium, Michigan Avenue/Oak Street, Canal Street/Adams Street, which are predominantly located along the water.")
